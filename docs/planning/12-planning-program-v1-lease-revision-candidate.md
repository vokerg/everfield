# Planning Program v1 — Schema-3 Ownership Lease Revision Remediated Candidate

**State:** REVIEWED-LEASE-REVISION-REMEDIATED-CANDIDATE  
**Authority:** NON-CANONICAL until fresh verification/compatibility and separately authorized squash-only canonicalization complete.  
**Revision issue:** #1137 / `FACTORY-LEASE-CANON-REV-REM-01`  
