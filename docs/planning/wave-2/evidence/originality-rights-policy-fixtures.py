#!/usr/bin/env python3
"""Self-contained deterministic delta fixture for W2-REM-RIGHTS-06.

Planning evidence only; not production or legal logic. The exact immutable
Issue #142 predecessor fixture is retained beside this file in the resulting
tree. This layer preserves the Issue #148 duplicate-derived-trigger correction
and removes only its dependency on task-branch Git-object reachability.
"""
...
BASE_FIXTURE_FILENAME = "originality-rights-policy-fixtures-predecessor-issue-142.py"
...
exec(compile(_base_source, f"retained-git-blob:{BASE_FIXTURE_BLOB}", "exec"), _NS)
