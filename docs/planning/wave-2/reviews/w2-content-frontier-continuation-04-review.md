...
PASS. Issue #1201 terminal binds the exact head, PR, base, three artifact paths, and artifact blob identities above. PR #1208 remains draft, open, and mergeable against unchanged `main@f8fec7bd94a1e67d44117e82bde672c411825570`. The changed-file list is exactly the three compiler-owned paths.
