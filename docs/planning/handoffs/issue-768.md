...
## Verification
- `python3 -m py_compile` of the new v3 source: PASS in producer environment;
- focused deterministic v3 invariants executed against a minimal compatibility harness: PASS;
...
- current producer work head before this handoff commit: `a89caa97f73d807880fa6555c123e49a1313d78d`.

## Required review
Fresh independent/degraded-independent review must inspect the exact immutable producer head and attack at minimum:
